...
const Projects = () => {
  return (
    <div className='py-10 md:-mt-40 xl:mt-0 px-10 text-white' id='project'>
      <div>
        <Reveal>
          <p className=' text-2xl md:text-3xl text-green-400 font-bold'>My Projects</p>
        </Reveal>
      </div>
      <div className=' pt-10 md:p-20 flex flex-col-reverse xl:flex-row justify-between'>
        {/* Amazon */}
        <ProductReveal>
          <div className=' border-2 border-white mt-5 xl:mt-0 p-2 md:p-10 rounded-3xl bg-white md:w-[600px]'>
            <a href="https://devsaqibhussain.github.io/amazon/" target='blank'>
              <img src="https://devsaqibhussain.github.io/portfolio/images/amazon-frame.png" alt="Amazon Project showcase" />
            </a>
          </div>
        </ProductReveal>
      ...
      <div className=' pt-10 md:px-20 xl:flex justify-between'>
        {/* SpaceThings */}
        <div className=' md:w-[600px]'>
          <Reveal>
        ...
        <ProductReveal>
          <div className=' border-2 border-white mt-5 xl:mt-0 p-2 md:p-5 rounded-3xl bg-white md:w-[600px]'>
            <a href="https://devsaqibhussain.github.io/responsive/" target='blank'>
              <img src="https://devsaqibhussain.github.io/portfolio/images/space-things.png" alt="Amazon Project showcase" />
            </a>
          </div>
        </ProductReveal>
      </div>
